...
if __name__ == "__main__":
    ...
    #change default logging level with , set write in log file , change format
    #ref for change logging format : https://docs.python.org/3/library/logging.html#logrecord-attributes
    logging.basicConfig(level=logging.DEBUG,filename='testing.log',format='%(asctime)s:%(levelname)s:%(name)s:%(message)s')

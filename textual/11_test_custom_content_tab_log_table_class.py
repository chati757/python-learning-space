...
class TestViweApp(App):
    ...
    def compose(self) -> ComposeResult:
        with Vertical():
            yield CustomTabContentLogTable(css_id='CustomTabContentLogTable',border_title='DCI_SERIES',cursor_type='row')

    async def on_mount(self) -> None:
        custom_dci_series_tab_log_table = self.query_one("CustomTabContentLogTable")
